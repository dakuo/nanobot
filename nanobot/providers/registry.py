...
PROVIDERS: tuple[ProviderSpec, ...] = (
    ...
    # Anthropic OAuth: uses browser-based OAuth login (Claude Pro/Max subscription).
    # Routes through LiteLLM with an OAuth Bearer token instead of an API key.
    ProviderSpec(
        ...
        skip_prefixes=("anthropic/", "anthropic-oauth/", "anthropic_oauth/"),
        is_oauth=True,
        supports_prompt_caching=True,
    ),
